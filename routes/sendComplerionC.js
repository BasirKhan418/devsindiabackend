...
try{
   ...
   let a  = await InternUser.findByIdAndUpdate({_id:req.body.id},{ccurl:req.body.url});
   ...
   const transporter = await nodemailer.createTransport({
    ...
    <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border: 1px solid #e0e0e0; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        <div style="background-color: #0073e6; padding: 20px; text-align: center;">
            <img src="https://res.cloudinary.com/dst73auvn/image/upload/v1714112756/logogif_slfyto.gif" alt="DevsIndia Logo" style="max-width: 150px; margin-bottom: 20px;">
        </div>
